#ifndef LIBYCRES_INCLUDE_PRO_TYPES_OBJECT_ITEM_DRUG_H
#define LIBYCRES_INCLUDE_PRO_TYPES_OBJECT_ITEM_DRUG_H
...
#endif //LIBYCRES_INCLUDE_PRO_TYPES_OBJECT_ITEM_DRUG_H
